#!/bin/bash
# Sweep ESS threshold on molecular synthesis with token-level model
# Tests: 0.0, 0.2, 0.4, 0.5, 0.6, 0.8 on 50 instances
...
N_PARTICLES=5
MAX_INSTANCES=50
OUTPUT_DIR="results_molecular_sweep_token"
...
echo "=========================================="
echo "Molecular Synthesis ESS Threshold Sweep (Token-Level)"
echo "=========================================="
echo "Model: $MODEL"
...
for ess in "${ESS_THRESHOLDS[@]}"; do
    ...
    LOG_FILE="$OUTPUT_DIR/molecular_token_ess${ess}.log"
    
    python run_molecular_eval_token.py \
        --model $MODEL \
